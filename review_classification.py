...
# load in file
data = pd.read_json(inputfile,lines=True) #python engine is slower than c but i'm having some trouble with some of the chars
...
#maybe think about taking any #s out?
