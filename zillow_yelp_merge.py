...
def merge_files(file1 = "zillow.csv", file2 = "business_review_test.csv"):
    ...
    result_df.to_csv('reviews_housing.csv')
...
def select_LA_county(file = "reviews_housing.csv"):
    ...
    for index, row in data_frame.head().iterrows():
        ...
        if row['zip_code'] in LA_zip:
            LA_csv.append(row)
    write_to_csv(LA_csv, "la_county_reviews_housing.csv")
